              ...
              {isFilterOpen && (
                <div className="flex h-full w-fit flex-col gap-4">
                  <Button
                    variant="ghost"
                    size="icon"
                    className="absolute right-3 top-3 hidden h-4 w-4 rounded-full p-0 opacity-70 ring-offset-background transition-opacity data-[state=open]:bg-secondary hover:bg-transparent hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none sm:block"
                    onClick={closeFilter}
                  >

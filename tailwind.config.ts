  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        h5: "var(--h5)",
        h6: "var(--h6)",
        p: ["1rem", { lineHeight: "1.2rem" }],
        pxs: ["0.7rem", { lineHeight: "1rem" }],
      ...
      animation: {
        ...
        "spin-slow": "spin 5s linear infinite", // Custom slow spin animation
        "spin-fast": "spin 0.5s linear infinite", // Custom fast spin animation
      },
      boxShadow: {
        // light
